...
@Component({
  ...
  templateUrl: './shift-add-old.component.html',
  styleUrl: './shift-add-old.component.css'
})
export class ShiftAddOldComponent implements OnInit {
